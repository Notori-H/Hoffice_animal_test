/* Office Animal Test: sharing + summary PNG card add-on */
(function () {
  "use strict";
  ...
  const css = `
    ...
    .share-card-header{position:relative;z-index:1;text-align:center}.share-card-eyebrow{color:#ff7658;font-size:18px;font-weight:900;letter-spacing:.12em;text-transform:uppercase}
    ...
    .share-card-character img{max-width:430px;max-height:325px;object-fit:contain;filter:drop-shadow(0 18px 18px rgba(55,42,30,.14))}.share-card-emoji{font-size:210px;line-height:1}
    ...
    .share-card-box-title{margin-bottom:9px;font-size:17px;font-weight:900}.share-card-box-text{color:#554e48;font-size:18px;line-height:1.65;letter-spacing:-.015em;word-break:keep-all;overflow-wrap:break-word}
    .share-card-centralization{border-color:rgba(255,118,88,.2);background:#fff1eb}.share-card-centralization .share-card-box-title{color:#d95d42}
    ...
    .event-btn{color:#51483e;background:#f5efe6}.shared-notice{max-width:560px;margin:0 auto 28px;padding:16px 18px;border:1px solid #ffd5c8;border-radius:18px;color:#7c4938;background:#fff4ef;text-align:center;font-size:14px;line-height:1.7}
    .actions .btn{min-width:180px}@media(max-width:600px){.actions{display:grid;grid-template-columns:1fr}.actions .btn{width:100%}}
  `;
  ...
  function buildShareCard(type) {
    ...
    header.innerHTML = '<div class="share-card-eyebrow">Office Animal Test</div>';
    ...
    image.onerror = function () {
      character.innerHTML = '<div class="share-card-emoji"></div>';
      character.firstChild.textContent = result.emoji;
    };
